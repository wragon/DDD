...
classLabels = 'yolov3/coco.names'

# eyes file
detector = dlib.get_frontal_face_detector()
predictor = dlib.shape_predictor('modul/shape_predictor_68_face_landmarks.dat')
cnn_model = keras.models.load_model("modul/cnn_model.h5")
...
# Dlib library eye points calculation
...
# Dlib library eye points prediction
...
if __name__ == "__main__":
    ...
    while True:
        ...
        for i in resultDet:
            ...
            elif "cigarette" in label:
                cv2.putText(frame, "Warning!", (40, 280), cv2.FONT_HERSHEY_TRIPLEX, 4.0, (0, 0, 255), 5)
            elif "razor" in label:
                cv2.putText(frame, "Warning!", (40, 280), cv2.FONT_HERSHEY_TRIPLEX, 4.0, (0, 0, 255), 5)
            elif "lipstick" in label:
                cv2.putText(frame, "Warning!", (40, 280), cv2.FONT_HERSHEY_TRIPLEX, 4.0, (0, 0, 255), 5)
